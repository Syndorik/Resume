...
#                                                                                                                #                                                                                                                #
###################################################################################################################################################################################################################################
# Libraries for multithreading, GUI and others #
################################################
...
def callback (key) :
    ...
    # We set the decision and allow the player to process the decision (the test avoids long key press)
    global decision
...
###################################################################################################################################################################################################################################
# Executed when the program exits, to enable key repetition again #
###################################################################

def enableKeyRepetition () :

    # We enable key repetition
    os.system("xset r on")
...
def preprocessing (mazeMap, mazeWidth, mazeHeight, playerLocation, opponentLocation, piecesOfCheese, timeAllowed) :
    ...
    atexit.register(enableKeyRepetition)
